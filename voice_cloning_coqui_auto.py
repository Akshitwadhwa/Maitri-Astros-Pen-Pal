#!/usr/bin/env python3
"""
Real Voice Cloning using Coqui TTS with automatic license acceptance
...
class CoquiVoiceCloner:
    ...
    def initialize_tts(self):
        ...
        try:
            ...
            # Create a string that simulates typing 'y' and pressing enter
            license_input = io.StringIO('y\n')
            
            with redirect_stdin(license_input):
...
def main():
    ...
    print("🎤 Coqui Voice Cloning System (Auto License)")
    print("=" * 45)
